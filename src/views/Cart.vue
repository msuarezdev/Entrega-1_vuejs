    ...
    <div>
        ...
        <b-container fluid class="mt-4">
                ...
                <b-col class="text-center">
                    <b-table bordered hover :items="cart" :fields="fields">
                        ...
                        <template v-slot:cell(quantity)="data">
                            <b-row>
                                <b-col cols="3" class="text-center">
                                    <b-button :disabled="data.item.quantity <=1"
                                    variant="info" @click="decrement(data.item.id)" class="mr-2">
                                    - </b-button>
                                </b-col>
                                ...
                                <b-col cols="3" class="text-center">
                                    <b-button variant="info" @click="increment(data.item.id)" class="mr-2">
                                        +
                                    </b-button>
                                </b-col>
                            </b-row>
                        ...
                        <template v-slot:cell(image)="data">
                            <b-col class="text-center">
                                <b-img style="max-width: 5rem;" :src="require(`@/assets/img/foods/food${data.item.id}.jpg`)" fluid alt="Responsive image"></b-img>
                            </b-col>
                        </template>
                    </b-table>
                </b-col>
            ...
            <b-row class="mt-4 text-center" v-if="cart.length > 0">
                ...
                <b-col></b-col>
                <b-col cols="4"> Desarrollado por Matias Suarez </b-col>
                <b-col></b-col>
                <b-col>
            ...
            centered title="Compra Completada">
            ...
            <ul v-for="productFinal in ticket.products" :key="productFinal.id">
                <li>
                    Nombre de producto: {{productFinal.name}}
                </li>
                <li>
...
export default {
    name: 'Cart',
    components: {
        navbar    //Bug al querer usar el componente 
    },
    data(){
        return{
            ticket: {
